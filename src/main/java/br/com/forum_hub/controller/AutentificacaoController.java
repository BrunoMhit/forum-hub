...
public class AutentificacaoController {
    ...
    public AutentificacaoController(AuthenticationManager authenticationManager, TokenService tokenService) {
    ...
    public ResponseEntity<DadosToken> efetuarLogin(@Valid @RequestBody DadosLogin dados){
        ...
        return ResponseEntity.ok(new DadosToken(tokenAcesso));
    }
}
